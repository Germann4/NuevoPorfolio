function Projects(){
    ...
    return (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-12">
        ...
        <div className="bg-white w-full max-w-[320px] h-auto p-4 rounded-lg shadow-lg text-center transform transition duration-300 hover:scale-105 hover:shadow-2xl ContainerProyect">
          <img
