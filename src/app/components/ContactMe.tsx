        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="mt-1 block w-full text-xs sm:text-sm md:text-base px-2 sm:px-3 py-1 sm:py-2 border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-500 focus:outline-none"
            />
          </div>
          ...
          {/* Mensaje */}
          <div>
            <label htmlFor="message" className="block text-xs sm:text-sm md:text-base font-medium text-gray-700">
              Mensaje
            </label>
            <textarea
              id="message"
          ...
          <div className="text-center">
            <button
              type="submit"
              className="bg-blue-500 text-white text-xs sm:text-sm md:text-base px-3 sm:px-4 py-1 sm:py-2 rounded-lg shadow-md hover:bg-blue-600 focus:ring focus:ring-blue-500 focus:outline-none"
            >
              Enviar
            </button>
          </div>
